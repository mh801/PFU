...
class SQLQuery {
	...
	function fetchAll($field = null,$value=null){
			global $inflect;
	...
	function save($update = null) {
		$query = '';		
		if (isset($this->id) && $update == true) {
			$updates = '';
			...
			if($update == null && !isset($this->id)){
				$query = 'INSERT INTO '.$this->_table.' ('.$fields.') VALUES ('.$values.')';
				//$query = 'INSERT INTO '.$this->_table.' ('.$fields.') VALUES (null,\'f\',\'l\',\'mmm@mmm.com\',\'1234\')';
			}
		}
		$this->_result = mysql_query($query, $this->_dbHandle);
	//	$this->clear();
